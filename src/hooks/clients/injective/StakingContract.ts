...
export type QueryResponse = {
  info: {
    admin: Addr;
    binj_backing: Uint128;
    binj_in_contract: Uint128;
    binj_to_burn: Uint128;
    binj_token: Addr;
    dev_address: Addr;
    dev_fee: number;
    epoch_period: number;
    ...
    seinj_backing: Uint128;
    seinj_in_contract: Uint128;
    seinj_to_burn: Uint128;
    seinj_token: Addr;
    to_deposit: Uint128;
...
export interface StakingContractReadOnlyInterface {
  seinjExchangeRate: () => Promise<any>;
  binjExchangeRate: () => Promise<any>;
...
export class StakingContractQueryContract extends Contract implements StakingContractReadOnlyInterface {
  constructor(client: SigningCosmWasmClient, contractAddress: string, contractHash?: string) {
    ...
    this.seinjExchangeRate = this.seinjExchangeRate.bind(this);
    this.binjExchangeRate = this.binjExchangeRate.bind(this);
  ...
  seinjExchangeRate = async (): Promise<any> => {
    return this.queryMsg({
      seinj_exchange_rate: {}
    });
  };
  binjExchangeRate = async (): Promise<any> => {
    return this.queryMsg({
      binj_exchange_rate: {}
    });
  };
...
export class StakingContractContract extends StakingContractQueryContract implements StakingContractInterface {
  constructor(client: SigningCosmWasmClient, contractAddress: string, contractHash?: string) {
    ...
    this.stakeForBinj = this.stakeForBinj.bind(this);
    this.claim = this.claim.bind(this);
    this.claimAndStake = this.claimAndStake.bind(this);
    this.updateSeinjAddr = this.updateSeinjAddr.bind(this);
    this.updateBinjAddr = this.updateBinjAddr.bind(this);
